    ...
    return(
        <Center flex={1} px={3}>
            <Text>
                ...
                <Text>1.4                             The Parties wish to enter into this Agreement to record and regulate their business relationship.
                </Text>
...
1.22                  Vehicle
                        ...
                        means any vehicle of the Customers that meets the onboarding requirements and is authorised to use by Etapath to provide the Transportation Services.
...
The Customers understand that Etapath may retain the Customers’ personal data for legal, regulatory, safety, and other necessary purposes after this Agreement is terminated. Etapath processes personal data in accordance with its privacy policy located at https://www.etapath.com/.
...
8.3.1.1                                                         that may have accrued before the termination of this Agreement; or

8.3.1.2                                                         which specifically or by their nature survive the termination of this Agreement.
...
4.3.3.1                                                         It shall take all precautions, including maintaining adequate insurance that meets the requirements of all applicable laws regarding any acts or omissions of Users or third parties;

4.3.3.2                                                         It shall not transport or allow inside any Vehicle individuals other than Users during the performance of Transportation Services; and

4.3.3.3                                                         Users shall be transported directly to the drop-off locations specified by the Grouped Trip and shall not make any unauthorized stops.
...
4.4.2.1                                                         this Agreement is not an employment agreement, nor does it create an employment relationship (including from a labour law, tax law or social security law perspective), between Etapath and the Driver; and

4.4.2.2                                                         no joint venture, partnership, or agency relationship exists between Etapath and the Driver.
...
4.4.5.1                                                         when or for how long the Driver will utilise the Driver Profile or the Etapath Services; or

4.4.5.2                                                         the Driver’s decision to accept, receive or cancel Grouped Trips subject to the rules and regulations contained in Drivers Code of Conduct and the Driver Guideline to Safety and Health Practices.
...
4.6.1.1                                                         After providing the Transportation Services and completing a Grouped Trip, the User may provide comments or feedback about such Transportation Services and Grouped Trip; and

4.6.1.2                                                         The Users may be prompted by the Driver Profile to provide comments or feedback on the Transportation Services and Grouped Trip.
...
4.7.2.1                                                         The Device requires a data plan in order for the Driver to provide Transportation Services at the Driver’s own expense; and

4.7.2.2                                                         Use of the Driver Profile consumes large amounts of data
...
4.8.2.1                                                         His or her geo-location information will be monitored and tracked by the Etapath Services once installed or authorised on the Device; and

4.8.2.2                                                         the approximate location of Driver’s Vehicle will be displayed to Etapath and the User before and during the provision of Transportation Services.

4.8.2.3                                                         Etapath may monitor, track and share the Driver’s geo-location information obtained by the Driver Profile and Device for safety, security, technical, marketing and commercial purposes, including to provide and to improve Etapath’s products and services.
...
5.1.1.1                                                         a valid Driver license and Provisional Driving Permit (“PDP”) with the appropriate level of certification to operate the Vehicle, and

5.1.1.2                                                         all licenses, permits, approvals and authority necessary to provide passenger transportation services to third parties in the Territory;

5.1.1.3                                                         the appropriate and current level of training, expertise and experience to provide Transportation Services in a professional manner with due skill, care and diligence; and

5.1.1.4                                                         high standards of professionalism, service and courtesy.
...
5.2.1.1                                                         properly registered and licensed to operate as a passenger transportation vehicle in the Territory;

5.2.1.2                                                         owned or leased by the Driver or otherwise in Driver’s lawful possession;

5.2.1.3                                                         suitable for performing the passenger transportation services contemplated by this Agreement; and

5.2.1.4                                                         maintained in good operating condition, consistent with industry safety and maintenance standards for a Vehicle of its kind and any additional standards or requirements in the applicable Territory, and in a clean and sanitary condition.
...
6.7.4.2                                                         The Driver acknowledges and agrees that at the end of each week, Etapath will calculate and set off:
